...
export const Response: React.FC<Props> = memo(
  ({ stepNum, response }: { stepNum: number; response: string }) => {
    ...
    return (
        <div className="flex flex-col items-center gap-5">
          <textarea
            className="border-[1px] border-gray-300 rounded-md p-3 m-0 h-[55vh]"
